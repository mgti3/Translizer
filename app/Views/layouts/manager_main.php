...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="/Translizer/public/manager_dashboard">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/Translizer/public/manager_assignment">
                    <i class="fas fa-fw fa-bars"></i>
                    <span>Task Assignment</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/Translizer/public/manager_tickets">
