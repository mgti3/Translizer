...
<body class="bg-gradient-primary" style="overflow: hidden;">
    ...
    <div class="text-center">
        <h1 class="mt-3 text-white">Welcome back!</h1>
        <img src="./assets/img/logo.png" alt="logo" style="width: 800px; height: auto; position: absolute;  transform: translate(-900px, -80px); opacity: 0.4;">
    </div>
